...
const SettingsPage = () => {
  ...
  return (
    <main className="container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        ...
        <article className="rounded-xl border border-base-300 overflow-hidden bg-base-100 shadow-lg">
          <div className="p-4 bg-base-200">
            <div className="max-w-lg mx-auto">
              {/* Mock Chat UI */}
              <section className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                <header className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Chill Guy</h3>
